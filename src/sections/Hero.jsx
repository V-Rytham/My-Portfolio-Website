...
export const Hero = () => {
  const handleDownloadCv = () => {
    ...
    a.href = "/Rytham_Maalpani_Resume.pdf";
    a.download = "Rytham_Maalpani_Resume.pdf";
      ...
      <div className="container mx-auto px-6 pt-32 pb-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            {/* CTAs */}
            <div className="flex flex-wrap gap-4 reveal reveal-up animation-delay-300">
              <Button
                size="lg"
                onClick={() =>
                  document
            ...
            {/* Social Links */}
            <div className="flex items-center gap-4 reveal reveal-left animation-delay-400">
              ...
              {[
                ...
                { icon: Twitter, href: "https://leetcode.com/u/Rytham44/" },
              ].map((social, idx) => (
                <a
                  key={idx}
                  href={social.href}
          ...
          <div className="relatice reveal reveal-zoom animation-delay-300">
            {/* Profile Image */}
        ...
        {/* Skills Section */}
        <div className="mt-20 reveal reveal-up animation-delay-600">
